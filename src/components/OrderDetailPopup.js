    ...
    return (
        ...
        >
            ...
            <Modal.Body>
                ...
                <p>Name: {props.order.restaurant.restaurantDetail.name}</p>
                <p>Address: {props.order.restaurant.restaurantDetail.address.line1},{props.order.restaurant.restaurantDetail.address.line2},{props.order.restaurant.restaurantDetail.address.city},{props.order.restaurant.restaurantDetail.address.state}-{props.order.restaurant.restaurantDetail.address.pincode}</p>
                <h4>Items</h4>
                <ul>
                    {
